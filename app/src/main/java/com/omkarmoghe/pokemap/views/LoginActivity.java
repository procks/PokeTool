...
public class LoginActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button signInButtonGoogle = (Button) findViewById(R.id.sign_in_button);
//        signInButtonGoogle.setSize(SignInButton.SIZE_WIDE);
    ...
    private void showPTCLoginFailed() {
        showProgress(false);
        Toast.makeText(this, getString(R.string.toast_ptc_login_error), Toast.LENGTH_LONG).show();
    }

    private void showGoogleLoginFailed() {
        showProgress(false);
        Toast.makeText(this, getString(R.string.toast_google_login_error), Toast.LENGTH_LONG).show();
    }
